    ...
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed inset-0 z-50 backdrop-blur-sm flex items-center justify-center p-4 ${
          isPastel ? 'bg-black/40' : 'bg-black/70'
        }`}
        role="dialog"
        aria-modal="true"
      ...
      >
        <motion.div
          ...
          className={`rounded-2xl border-2 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col ${
            isPastel
        ...
        >
          ...
          style={isPastel ? {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 id="save-options-dialog-title" className={`text-2xl font-bold ${
                    isPastel
              ...
              <div className="space-y-4">
                ...
                {isDetecting ? (
                  <div className="flex items-center justify-center py-4">
                    <div className={isPastel ? 'text-gray-600' : 'text-gray-400'}>Detecting existing folders...</div>
                  </div>
                ) : (
                  <>
                    {/* Save Loose Option */}
                    <label className={`flex items-center gap-3 p-4 rounded-lg border cursor-pointer transition-colors group ${
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <FileText className={`w-4 h-4 ${isPastel ? 'text-gray-600' : 'text-gray-400'}`} />
                    ...
                    {selectedOption === 'save-loose' && (
                      <div className={`ml-8 pl-4 border-l-2 space-y-3 ${
                        isPastel ? 'border-pink-300/30' : 'border-cyber-purple-400/30'
                      }`}>
                        <label className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-colors group ${
                          ...
                          <div className="flex-1">
                            ...
                            }`}>Create New Folder inside case file</span>
                          </div>
                        </label>
                    ...
                    {!hasExistingFolder && (
                      <>
                        <label className={`flex items-center gap-3 p-4 rounded-lg border cursor-pointer transition-colors group ${
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <FolderPlus className={`w-4 h-4 ${isPastel ? 'text-gray-600' : 'text-gray-400'}`} />
                              <span className={`text-sm font-medium ${
                                isPastel ? 'text-gray-700' : 'text-gray-200'
                              }`}>Make PDF Folder</span>
                            </div>
                            <p className={`text-xs mt-1 ${
                              isPastel ? 'text-gray-500' : 'text-gray-500'
                            }`}>
                    ...
                    {hasExistingFolder && (
                      <>
                        ...
                        <label className={`flex items-center gap-3 p-4 rounded-lg border cursor-pointer transition-colors group ${
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <FolderOpen className={`w-4 h-4 ${isPastel ? 'text-gray-600' : 'text-gray-400'}`} />
                              <span className={`text-sm font-medium ${
                                isPastel ? 'text-gray-700' : 'text-gray-200'
                              }`}>
                                Add to PDF Folder
                              </span>
                              <span className={`text-xs ${isPastel ? 'text-gray-500' : 'text-gray-500'}`}>({firstExistingFolder.name})</span>
                            </div>
                            <p className={`text-xs mt-1 ${
                              isPastel ? 'text-gray-500' : 'text-gray-500'
                            }`}>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    value={saveDirectory}
                    readOnly
                    className={`flex-1 px-4 py-3 border rounded-lg text-sm focus:ring-2 focus:border-transparent ${
                      isPastel
                        ? 'bg-white/80 border-pink-200/50 text-gray-700 focus:ring-pink-400'
                        : 'bg-gray-800 border-gray-700 text-white focus:ring-cyber-purple-400'
                    }`}
            ...
            {(!casePath || !pdfPath || selectedOption === 'make-pdf-folder') && selectedOption !== 'add-to-pdf-folder' && selectedOption !== 'add-folder-to-directory' && (
              <div>
                <label className={`block text-sm font-semibold mb-3 ${
                  ...
                  Folder Name {!casePath && <span className={isPastel ? 'text-red-500' : 'text-red-400'}>*</span>}
                </label>
                <input
                  type="text"
                  value={folderName}
                  ...
                  className={`w-full px-4 py-3 border rounded-lg text-sm focus:ring-2 focus:border-transparent ${
                    folderNameError
                      ? 'border-red-500 focus:ring-red-500/20 focus:border-red-500'
                      : isPastel
                      ? 'bg-white/80 border-pink-200/50 text-gray-700 focus:ring-pink-400'
            ...
            <div className="space-y-4">
              ...
              <label className={`flex items-center gap-3 p-4 rounded-lg border cursor-pointer transition-colors ${
                ...
                <input
                  ...
                  className={`w-5 h-5 rounded border-gray-600 focus:ring-offset-2 ${
                    isPastel
                      ? 'text-pink-400 focus:ring-pink-400 focus:ring-offset-white'
                      : 'text-cyber-purple-400 focus:ring-cyber-purple-400 focus:ring-offset-gray-900'
                  }`}
                />
                <div className="flex-1">
                  <div className="flex items-center gap-2">
            ...
            <div>
              ...
              {fileNamingPattern === 'custom' && (
                <input
                  ...
                  className={`w-full mt-3 px-4 py-3 border rounded-lg text-sm focus:ring-2 focus:border-transparent ${
                    isPastel
                      ? 'bg-white/80 border-pink-200/50 text-gray-700 focus:ring-pink-400'
                      : 'bg-gray-800 border-gray-700 text-white focus:ring-cyber-purple-400'
                  }`}
          ...
          <div className={`p-6 border-t flex items-center justify-end gap-3 ${
            isPastel
              ? 'border-pink-200/30 bg-pink-50/30'
            ...
            <button
              ...
              className={`px-6 py-2.5 text-white rounded-lg font-medium transition-all disabled:cursor-not-allowed flex items-center gap-2 ${
                isPastel
