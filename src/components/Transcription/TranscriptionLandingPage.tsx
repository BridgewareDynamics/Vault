  ...
  const actionCards: LandingActionCard[] = [
    {
      ...
      description:
        'Start from a blank transcript workspace, add media, then run the engine with advanced settings and export-ready outputs.',
    ...
    },
    {
      ...
      description:
        'Browse completed, in-progress, and case-linked transcripts with quick context, excerpts, and status.',
      cta: 'Browse Library',
          ...
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-6 py-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                ...
                <h1 className={`text-xl font-bold md:text-2xl ${t.heading}`}>Transcript</h1>
              </div>
            </div>
          </div>
        </header>
            ...
            <HolographicEffect className="rounded-[32px]" intensity={t.isPastel ? 0.18 : 0.28}>
              ...
              >
                <div className="space-y-6 rounded-[28px] border p-6 md:p-7">
                  <div className={`inline-flex w-fit items-center gap-2 rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.26em] ${t.softInsetSurface}`}>
            ...
            >
              <div className="space-y-5">
                <div>
                  ...
                  <h3 className={`mt-3 text-2xl font-bold ${t.heading}`}>A transcript command center built into Vault</h3>
                </div>
