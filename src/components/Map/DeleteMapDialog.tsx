        ...
        >
          <div className="flex items-start justify-between gap-4 px-6 py-5 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="delete-map-dialog-title" className="text-xl font-bold text-red-400">
                  Delete Map
                </h2>
                <p className={`text-sm ${t.muted}`}>Remove this map from your library</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="px-6 py-5">
            <p
              ...
              className={`${t.isPastel ? 'text-gray-700' : 'text-gray-200'} text-sm leading-6`}
            >
              Are you sure you want to delete{' '}
              <span className="font-semibold">{mapTitle?.trim() ? `"${mapTitle}"` : 'this map'}</span>
              ?
            </p>
            <p className="mt-3 text-sm text-red-400">
              This permanently removes the saved map and its attached map assets.
            </p>
          </div>
